...
const robber = preload("res://map/robber.tscn")
const robber_hint_button = preload("res://map/robber_button_hint.tscn")
var instance: Node
...
# Isn't really necessary for this but i like to sort the tiles anyway.
